...
const ARMOR = [
  ...
  { name: "Riot Shield, Small", conceal: 99, bal: 1, imp: 1, wt: 2, avail: "8/14 days", cost: 1500, legality: "Restricted", notes: "A compact riot shield for pushing through a crowd or weathering a hail of fire. Impact value illegible in the source scan — placeholder 1, pending a physical-book capture. Street Index 2. SSC." },
